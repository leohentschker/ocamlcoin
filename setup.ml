...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0ee6665db4d2658bed5398dd0e92f577) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Leo Hentschker <lhentschker@gmail.com>"];
          homepage = Some "http://foobar.org";
          bugreports = None;
          synopsis = "An OCaml implementation of the blockchain";
          description =
            Some
              [
                 OASISText.Para
                   "OCamlcoin allows you to participate in a blockchain network written in OCaml"
              ];
          tags = [];
          categories = [];
          files_ab = [];
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "server.ml"})
            ];
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\019\024\ný:\152{3b\016ìF\\\157}9";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
